...
public class SpeedrunTimerModule {
    ...
    private void CheckLoading(string _sceneName = "", GameCore.GameCoreState _coreState = GameCore.GameCoreState.Playing, UnityEngine.UI.Image _blackCover = null, LoadingScreenPanel _loadingScreen = null)
    {
        ...
        try
        {
            ...
            if (loadingScreen is not null && loadingScreen.isActiveAndEnabled
                ...
                || (sceneName == "TitleScreenMenu" && blackCover is not null && blackCover.isActiveAndEnabled && blackCover.color.a > 0.99f)
