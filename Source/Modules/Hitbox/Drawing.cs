...
public static class Drawing {
    ...
    public static void DrawLine(Vector2 pointA, Vector2 pointB, Color color, float width, bool antiAlias) {
        ...
        if (antiAlias) Graphics.DrawTexture(lineRect, tex, lineRect, 0, 0, 0, 0, color, mat);
    ...
    public static void DrawBezierLine(Vector2 start, Vector2 startTangent, Vector2 end, Vector2 endTangent, Color color,
        float width,
